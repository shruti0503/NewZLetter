    ...
    <div className="bg-[#f7f5ff] h-[95vh]">
      ...
      <div className="w-full h-full flex justify-center items-center relative overflow-hidden">
        ...
        <div className="absolute">
          <h1 className="font-clashDisplay text-black uppercase font-bold text-cyber-ink text-[2.75rem] md:text-[7xl] lg:text-[4rem] xl:text-[5.75rem] max-w-4xl mx-auto text-center z-10">
          ...
          <div className="flex w-full justify-center">
            <Button color="primary" className="text-xl !p-8" onClick={handleNavigation}>
              Get Started
            </Button>
          </div>
          <br />
